...
namespace VisualSquirrel.Taggers
{
    ...
    {        
        ...
        public ITagger<T> CreateTagger<T>(ITextBuffer buffer) where T : ITag
        {
            ...
            return buffer.Properties.GetOrCreateSingletonProperty(delegate () { return new AttributeScopeTagger(TextSearchService, TextStructureNavigatorSelector, buffer, service as SQLanguageServiceEX, _classificationRegistry, _classifierAggregator); }) as ITagger<T>;
        }
    }

    internal class AttributeScopeTagger : ITagger<ClassificationTag>
    {
        private const string SQAtrributeFormat = "SQ - Attribute";
