...
namespace Microsoft.VisualStudio.IntellisensePresenter
{
    internal class CompletionSessionPresenter : IPopupIntellisensePresenter, IIntellisenseCommandTarget
    {
        ...
        internal SQCompletion SelectedCompletion
        {
            get
            {
                return session.SelectedCompletionSet.SelectionStatus.Completion as SQCompletion;
            }
            set
            {
...
#pragma warning restore 0067
        ...
        private void SelectCompletion(int relativeIndex)
        {
            ...
            {
                this.SelectedCompletion = completionSet.Completions[selectedCompletionIndex] as SQCompletion;
            }
        }
