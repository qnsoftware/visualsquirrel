...
namespace VisualSquirrel.Debugger.Engine
{
    public static class EngineUtils
    {
        public static string BuildCommandLine(string exe, string args)
        {
            ...
            if (exe.Length <= 0)
            {
                throw new ComponentException(EngineConstants.E_WIN32_INVALID_NAME);
            }
        ...
        public static string GetAddressDescription(DebuggedModule module, uint ip)
        {
            ...
            return location;*/
            return ip.ToString() + "GetAddressDescription(Alberto)";
        }
        ...
        {
            Debug.Fail("Unexpected exception during Attach [" + e.Message + "]");
            return EngineConstants.RPC_E_SERVERFAULT;
        }
